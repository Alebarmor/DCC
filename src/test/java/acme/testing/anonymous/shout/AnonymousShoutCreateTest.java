...
public class AnonymousShoutCreateTest extends AcmeOneTest {
	...
	public void createNegativeDate(final int recordIndex, final String author, final String text, final String info,
		final String keylet, final String deadline, final String budget) {
		...
		super.fillInputBoxIn("solim.keylet", keylet);
		super.fillInputBoxIn("solim.deadline", deadline);
		super.fillInputBoxIn("solim.budget", budget);
		super.fillInputBoxIn("solim.important", "true");
	...
	public void createNegative(final int recordIndex, final String author, final String text, final String info,
		...
		final String keylet =  currentYear + currentMonth + currentDay + "#" +"02";
	...
	public void createPositive(final int recordIndex, final String author, final String text, final String info,
		...
		final String keylet =  currentYear + currentMonth + currentDay + "#" +"1";
		...
		super.checkColumnHasValue(3, 3, keylet);
